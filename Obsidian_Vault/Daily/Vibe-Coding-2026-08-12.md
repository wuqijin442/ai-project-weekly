...
# GitHub AI 项目日报 · Vibe Coding 赛道 · 2026-08-12（工作日）

> 数据源：GitHub Trending 全局日榜（飙升榜，按当日新增 Star 降序） + GitHub REST API 实时补全 stars / topics / license。

## 🔝 今日最佳开源项目

**PrimeIntellect-ai/prime-agent** — 🔺1,138 / ⭐14.1k / TypeScript
...
| # | 项目 | 语言 | ⭐ | 📈 新增 | 入选依据 |
|---|---|---|---|---|---|
| 1 | [[Projects/PrimeIntellect-ai_prime-agent|PrimeIntellect-ai/prime-agent]] | TypeScript | 14.1k | 🔺1,138 | 生态扩充(分7) |
| 2 | [[Projects/semantica-agi_semantica|semantica-agi/semantica]] | Python | 4.9k | 🔺893 | 生态扩充(分9) |
| 3 | [[Projects/stablyai_orca|stablyai/orca]] | TypeScript | 42.8k | 🔺875 | ✅ 严格命中 |
...
- [[Projects/PrimeIntellect-ai_prime-agent|PrimeIntellect-ai/prime-agent]]
- [[Projects/semantica-agi_semantica|semantica-agi/semantica]]
- [[Projects/stablyai_orca|stablyai/orca]]
- [[Projects/HKUDS_DeepTutor|HKUDS/DeepTutor]]
